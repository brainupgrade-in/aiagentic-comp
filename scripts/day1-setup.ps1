...
Write-Host ""
Write-Host "Labs:"
Write-Host "  python hands-on/session-1/lab01_meet_your_llm.py"
Write-Host "  python hands-on/session-2/lab01_coding_agent_anatomy.py"
Write-Host "  python hands-on/session-3/lab01_chain_of_thought.py"
Write-Host ""
