...
echo "  hands-on/session-1/lab01_meet_your_llm.ipynb"
echo "  hands-on/session-2/lab01_coding_agent_anatomy.ipynb"
echo "  hands-on/session-3/lab01_chain_of_thought.ipynb"
echo ""
