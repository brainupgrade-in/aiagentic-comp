...
Write-Host ""
Write-Host "Labs:"
Write-Host "  python hands-on\session-10\lab01_three_pillars.py"
Write-Host "  python hands-on\session-11\lab01_langfuse_fundamentals.py"
Write-Host "  python hands-on\session-12\lab01_fastapi_basics.py"
Write-Host ""
