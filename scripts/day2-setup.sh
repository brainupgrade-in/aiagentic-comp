...
echo "  Session 4: LangChain Fundamentals"
echo "  Session 5: Building RAG Applications"
echo "  Session 6: LangChain Agents & Memory"
echo ""
...
echo ""
echo "Labs: hands-on/session-4/ through session-6/"
echo ""
