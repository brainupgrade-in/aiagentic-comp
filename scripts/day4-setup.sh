...
echo "  hands-on/session-10/lab01_three_pillars.ipynb"
echo "  hands-on/session-11/lab01_langfuse_fundamentals.ipynb"
echo "  hands-on/session-12/lab01_fastapi_basics.ipynb"
echo ""
