...
an interactive bot that answers questions with citations.
...
print("=" * 50)
print("  Company Q&A Bot — Challenge Lab")
print("=" * 50)

# ============================================================
# PART A: Prepare the knowledge base
# ============================================================
# Here's a larger set of company documents. Your job is to split them
# into chunks, embed them, and store them in ChromaDB.
...
# TODO: Convert COMPANY_DOCS into LangChain Document objects,
# split them into chunks, and store in ChromaDB.
#
# Hints:
#   1. Create Document objects from each dict (text → page_content, rest → metadata)
#   2. Use RecursiveCharacterTextSplitter(chunk_size=400, chunk_overlap=50)
#   3. Use Chroma.from_documents() with HuggingFaceEmbeddings
#
# Starter code:
...
# ============================================================
# PART B: Create the RAG chain with citations
# ============================================================
# Build a RAG chain that:
#   1. Retrieves the top 4 relevant chunks
#   2. Formats them with source info
#   3. Uses a citation-aware prompt
#   4. Generates an answer with source references
#
# Hints:
#   - Retriever: vectorstore.as_retriever(search_kwargs={"k": 4})
#   - Format: include [source, page] before each chunk
#   - Prompt: tell the LLM to cite sources
...
# ============================================================
# PART C: Test with various questions
# ============================================================
# Test your bot with questions across all categories.
...
#     "What is the company's stock price?",  # out-of-scope test
# ]
#
...
# ============================================================
# Create separate chains for different categories so users can
# choose to search only within HR, Tech, or Office info.

# TODO: Create at least two filtered chains
...
# ============================================================
# PART E (Bonus): Interactive Q&A mode
# ============================================================
# Make it interactive! Let users type questions and get answers.
...
# ============================================================
# PART F (Bonus): Show retrieved chunks alongside the answer
# ============================================================
# Display both the answer AND the source documents that were used.

# TODO: Build a chain that returns both answer and sources
...
print("- Start with Part A (knowledge base), test it works, then Part B")
print("- Part C tests your chain — try both in-scope and out-of-scope questions")
print("- Part D shows how metadata filters create focused assistants")
print("- Parts E and F are bonus — do them if you have time")
