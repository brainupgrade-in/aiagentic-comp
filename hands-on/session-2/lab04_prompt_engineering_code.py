"""
Lab 04: Prompt Engineering for Code
======================================
Learn how prompt quality affects AI-generated code — from vague
one-liners to structured, high-quality prompts.

What you'll learn:
- Three levels of prompt quality (bad, good, great)
- Structured prompt template for code generation
- Rewriting bad prompts into great ones
...
WORKDIR = "/tmp/aidev-lab-02-04"

print("=" * 50)
print("  Lab 04: Prompt Engineering for Code")
print("=" * 50)
...
print("  A well-structured prompt reduces ambiguity and gives the LLM")
print("  clear constraints to work within.\n")


# ============================================================
# TODO 1: Rate 3 prompts
# ============================================================

print("\n--- TODO 1: Rate These Prompts ---\n")

print("  Rate each prompt as 'bad', 'good', or 'great'.\n")
...
for i, p in enumerate(prompts_to_rate, 1):
    if p["rating"] == "___":
        status = "TODO"
    elif p["rating"].strip().lower() == p["correct"]:
        status = "PASS"
        score1 += 1
    else:
        status = "FAIL"
    ...
    if status == "TODO":
        print(f"             (Rate as: 'bad', 'good', or 'great')")

print(f"\n  Score: {score1}/{len(prompts_to_rate)}")


# ============================================================
# TODO 2: Rewrite a bad prompt into a great prompt
# ============================================================
...
print(f"\n  Rewrite it as a GREAT prompt using the template from Step 2.")
print(f"  Your prompt must include at least:")
print(f"    - A function name")
print(f"    - Parameter types")
print(f"    - Return type")
print(f"    - At least one validation rule")
print(f"    - At least one error case\n")

# YOUR CODE HERE: Write a great version of the bad prompt
great_prompt = "___"
...
if great_prompt == "___":
    checks_2.append(("Has function name", "TODO"))
    checks_2.append(("Has type information", "TODO"))
    checks_2.append(("Has validation rule", "TODO"))
    checks_2.append(("Has error case", "TODO"))
else:
...
# ============================================================
# TODO 3: Generate a structured prompt from a task description
# ============================================================

print("\n\n--- TODO 3: Generate a Structured Prompt ---\n")

print("  Given the task metadata below, generate a structured prompt string")
print("  using the template from Step 2.\n")
...
# YOUR CODE HERE: Build a structured prompt string from task_meta
# It should be a multi-line string using the template fields
structured_prompt = "___"

score3 = 0
checks_3 = []

if structured_prompt == "___":
    checks_3.append(("Contains TASK", "TODO"))
    checks_3.append(("Contains LANGUAGE or FRAMEWORK", "TODO"))
    checks_3.append(("Contains INPUT/OUTPUT", "TODO"))
else:
