#!/usr/bin/env python3
"""
Lab 02: MCP Protocol — JSON-RPC 2.0 Messages
...
# TODO: Create a valid JSON-RPC 2.0 request dictionary.
#   - jsonrpc must be "2.0"
#   - id should be 1
#   - method should be "tools/list"
...
# TODO: Create a JSON-RPC 2.0 request to call the "search_code" tool.
#   - jsonrpc: "2.0"
#   - id: 2
#   - method: "tools/call"
#   - params: { "name": "search_code", "arguments": {"query": "def main", "path": "src/"} }
...
# TODO: Create a JSON-RPC 2.0 error response.
#   - jsonrpc: "2.0"
#   - id: 99
...
def validate_jsonrpc_request(msg: Dict[str, Any]) -> Tuple[bool, str]:
    ...
    #   1. msg must be a dict
    #   2. "jsonrpc" key must exist and equal "2.0"
    #   3. "id" key must exist and be an int or str
    #   4. "method" key must exist and be a str
    # Return (False, <reason>) for the first failing check.
    # Return (True, "ok") if all checks pass.
