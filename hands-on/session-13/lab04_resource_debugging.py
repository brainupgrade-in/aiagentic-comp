...
# YOUR CODE HERE: Analyze each scenario's output and identify the problem
# resource_scenarios[0]["answer"] = ???
# resource_scenarios[1]["answer"] = ???
# resource_scenarios[2]["answer"] = ???
# resource_scenarios[3]["answer"] = ???
...
# YOUR CODE HERE: Create the fixed Deployment with correct memory limits
fixed_deployment = textwrap.dedent("""\
    # TODO: Fix the Deployment above
    # Change memory request from 64Mi to 512Mi
    # Change memory limit from 128Mi to 1Gi (or 1024Mi)
