...
scenarios[1]["answer"] = "Config file missing — ConfigMap not mounted at /etc/redis/redis.conf"
scenarios[2]["answer"] = "Wrong command/entrypoint — typo 'pytohn' instead of 'python'"
scenarios[3]["answer"] = "OOMKilled — memory limit too low for model that needs 2.1 GB"
...
# SOLUTION: Create the FIXED Deployment YAML
