#!/usr/bin/env python3
"""
Lab 03 Solution: MCP Ecosystem Discovery
...
individual_scores = [1.0, 1.0, 0.7, 1.0, 0.7, 0.3]
readiness_score = round(sum(individual_scores) / len(individual_scores), 2)  # 0.78
