...
# SOLUTION: Fill in the correct kubectl commands
symptom_mappings["Pod keeps restarting (CrashLoopBackOff)"] = "kubectl logs POD --previous"
symptom_mappings["Pod stuck in Pending state"] = "kubectl describe pod POD"
symptom_mappings["Pod running but returning 500 errors"] = "kubectl logs POD"
symptom_mappings["Pod killed with OOMKilled"] = "kubectl top pods"
symptom_mappings["Cannot pull container image"] = "kubectl describe pod POD"
symptom_mappings["Service not routing traffic to pods"] = "kubectl get endpoints SERVICE"
...
# SOLUTION: Fill in the answer field for each quiz question
quiz[0]["answer"] = "kubectl logs POD --previous"
quiz[1]["answer"] = "kubectl describe pod POD"
quiz[2]["answer"] = "kubectl top pods"
quiz[3]["answer"] = "kubectl exec POD -- env"
quiz[4]["answer"] = "kubectl get events --sort-by=.lastTimestamp"
quiz[5]["answer"] = "kubectl top nodes"
