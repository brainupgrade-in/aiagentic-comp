#!/usr/bin/env python3
"""
Lab 03 Solution: MCP Server Skeleton — Code Generation
...
parts = [
    IMPORT_TEMPLATE,
    "",
    SERVER_INIT_TEMPLATE.format(server_name=server_name),
    "",
]
for tool in tool_definitions:
    parts.append(TOOL_TEMPLATE.format(**tool))

parts.append(ENTRY_TEMPLATE)
...
tool_count = file_content.count("@mcp.tool()")
has_init = 'mcp = FastMCP("code-assistant")' in file_content
has_main = "if __name__" in file_content

validation_result = (tool_count == 3) and has_init and has_main
