...
# SOLUTION: Fill in the answers for each anti-pattern
antipattern_quiz[0]["answer"] = "minReplicas=1 is a SPOF; maxReplicas=100 could cause cost explosion; targetCPU=50% is wasteful"
antipattern_quiz[1]["answer"] = "HPA cannot calculate CPU % without resource requests as baseline"
antipattern_quiz[2]["answer"] = "min=max means HPA cannot scale at all — it's effectively disabled"
antipattern_quiz[3]["answer"] = "HPA will flap — scale up on spike, immediately scale down, repeat"
