...
todo1_code = textwrap.dedent("""\
    ...
    # 5. Function with manual spans for RAG + LLM
    async def process_query(query: str):
        with tracer.start_as_current_span("agent_workflow") as workflow_span:
            workflow_span.set_attribute("agent.query", query)
...
quiz[0]["answer"] = "both"
quiz[1]["answer"] = "start_as_current_span"
quiz[2]["answer"] = "batches spans for efficient export"
quiz[3]["answer"] = "OTEL_SERVICE_NAME"
