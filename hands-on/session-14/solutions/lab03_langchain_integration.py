...
# SOLUTION: Instrument a LangChain RAG pipeline with LangFuse
todo1_code = textwrap.dedent("""\
    ...
    # Get trace_id for linking feedback
...
quiz[1]["answer"] = "callbacks"
quiz[2]["answer"] = "session_id"
