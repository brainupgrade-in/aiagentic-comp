"""
Lab 01: Code Quality Analysis Server
...
def count_functions(source_code: str) -> int:
    ...
    # TODO: Walk the tree and count FunctionDef + AsyncFunctionDef nodes
    tree = ast.parse(source_code)
    count = "___"
    return count
...
def calculate_complexity(source_code: str) -> dict:
    ...
    # TODO: Iterate over ast.walk(tree) to find FunctionDef/AsyncFunctionDef
    # TODO: For each function, walk its body and count branch nodes
    # TODO: Store function_name -> 1 + branch_count in complexities
    # Branch nodes: ast.If, ast.For, ast.While, ast.ExceptHandler, ast.With, ast.BoolOp
    complexities = "___"
...
def find_issues(source_code: str) -> list:
    ...
    # TODO: Walk the tree to detect:
    #   - Bare except: ExceptHandler where handler.type is None
    #     → append {"issue": "bare_except", "function": <enclosing func name>, "detail": "Bare except clause"}
    #   - Too many params: FunctionDef/AsyncFunctionDef with len(node.args.args) > 5
    #     → append {"issue": "too_many_params", "function": <func name>, "detail": "N parameters"}
    #   - Deep nesting: FunctionDef inside FunctionDef inside FunctionDef (depth > 2)
    #     → append {"issue": "deep_nesting", "function": <innermost func name>, "detail": "Nesting depth N"}
    issues = "___"
