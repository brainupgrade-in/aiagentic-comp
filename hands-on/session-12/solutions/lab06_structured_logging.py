...
logs = [
    {
        ...
        "json_str": '{"level": "INFO", "message": "llm_call_completed", "model": "llama3-70b", "tokens_in": 800, "tokens_out": 200, "cost_usd": 0.004, "duration_s": 1.8, "trace_id": "abc123"}',
        "check_fields": ["level", "model", "tokens"],
    },
    {
        "description": "Slow request warning (WARN): duration_s=8.5, endpoint=/chat, user_id=alice",
        "json_str": '{"level": "WARN", "message": "slow_request", "duration_s": 8.5, "endpoint": "/chat", "user_id": "alice", "trace_id": "def456"}',
        "check_fields": ["level", "duration", "user_id"],
    },
    {
        "description": "Error (ERROR): status=500, error='ChromaDB timeout', trace_id=xyz789",
        "json_str": '{"level": "ERROR", "message": "request_failed", "status": 500, "error": "ChromaDB timeout", "trace_id": "xyz789"}',
