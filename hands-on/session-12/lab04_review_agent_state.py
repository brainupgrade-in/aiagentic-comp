"""
Lab 04: Code Review Agent State Design
...
# TODO: Define REVIEW_STATE_SCHEMA as described above
REVIEW_STATE_SCHEMA = "___"


def create_state(diff: str) -> dict:
    """Create a new review state initialized with defaults."""
    # TODO: Start from a copy of REVIEW_STATE_SCHEMA defaults
    # TODO: Set "diff" to the provided diff parameter
    # TODO: Use dict comprehension or copy to avoid mutating defaults
    # Hint: For list defaults, create new lists (not references to the same list)
    state = "___"
    return state
...
def validate_state(state: dict) -> bool:
    ...
    # TODO: Check that every key in REVIEW_STATE_SCHEMA exists in state
    # TODO: Check that str-default fields have str values
    # TODO: Check that list-default fields have list values
...
def analyze_node(state: dict) -> dict:
    ...
    # TODO: Create a copy of state (use dict(state) + new lists)
    # TODO: Check diff for security patterns
    # TODO: Update issues list and file_analyses
    updated = "___"
    return updated
...
def test_node(state: dict) -> dict:
    ...
    # TODO: Set test_results based on whether issues were found
    updated = "___"
    return updated
...
def route_review(state: dict) -> str:
    ...
    # TODO: Check state["severity"] and return the appropriate next node
    result = "___"
    return result
