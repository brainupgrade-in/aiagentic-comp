"""
Lab 03: Documentation Generator Server
...
def extract_docstrings(source_code: str) -> list:
    ...
    # TODO: Check for module docstring with ast.get_docstring(tree)
    #       If present, append ("__module__", docstring)
    # TODO: Iterate over ast.iter_child_nodes(tree) — top-level nodes only
    # TODO: For FunctionDef, AsyncFunctionDef, ClassDef:
    #       Append (node.name, ast.get_docstring(node))
    results = "___"
...
def check_missing_docs(source_code: str) -> list:
    ...
    # TODO: Walk entire tree with ast.walk(tree)
    # TODO: For FunctionDef -> type="function", AsyncFunctionDef -> type="async_function",
    #       ClassDef -> type="class"
    # TODO: If ast.get_docstring(node) is None, append to missing list
    # TODO: Include node.lineno as "line"
    missing = "___"
...
def generate_readme(project_name: str, description: str, functions_list: list) -> str:
    ...
    # TODO: Start with f"# {project_name}\\n\\n{description}\\n"
    # TODO: Add "\\n## Functions\\n" section
    # TODO: For each (name, docstring) where docstring is not None:
    #       Add f"\\n### `{name}`\\n\\n{docstring}\\n"
    # TODO: Add "\\n## Undocumented\\n" section
    # TODO: For each (name, docstring) where docstring is None:
    #       Add f"- `{name}`\\n"
    # TODO: Add "\\n---\\n*Auto-generated documentation*\\n"
    readme = "___"
    return readme
