...
def run_tests(test_functions: list) -> list:
    ...
    # TODO: Loop through test_functions
    # TODO: For each function, try to call it
    # TODO: Catch AssertionError -> status "failed", detail = str(e)
    # TODO: Catch Exception -> status "error", detail = str(e)
    # TODO: No exception -> status "passed", detail = None
    # TODO: Append {"name": func.__name__, "status": ..., "detail": ...}
    results = "___"
...
def parse_test_results(output_text: str) -> dict:
    ...
    # TODO: Use regex to find "collected (\\d+) items?" for total
    # TODO: Find all lines matching pattern: <test_name> PASSED|FAILED|ERROR
    # TODO: Count each status
    # TODO: Collect names of failing/erroring tests
    result = "___"
    return result
...
def generate_test_report(results: list) -> dict:
    ...
    # TODO: Count passed, failed, error from results list
    # TODO: Calculate pass_rate = (passed / total) * 100 if total > 0 else 0.0
    # TODO: Collect failing_tests (status != "passed") with name and detail
    # TODO: Return dict with summary, pass_rate, failing_tests, status
    report = "___"
    return report
