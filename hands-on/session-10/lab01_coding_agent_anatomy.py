...
print("=" * 50)
print("  Lab 01: Coding Agent Anatomy")
print("=" * 50)
...
print("  A coding agent needs tools to interact with the file system,")
print("  run commands, and search code.  These are stored in a registry:\n")
...
# ============================================================
# TODO 1: Fill in the 5 phases in order
# ============================================================

print("\n--- TODO 1: Name the 5 Phases in Order ---\n")

# Fill in the 5 phases of a coding agent in the correct order.
# Each should be a lowercase string.
# Choices: "plan", "code", "test", "reflect", "iterate"
...
print("  Create a dict mapping tool names to descriptions.")
print("  Must include at least these 3 tools:")
print("    read_file  -> 'Read file contents'")
print("    write_file -> 'Write content to file'")
print("    run_tests  -> 'Execute test suite'\n")

# YOUR CODE HERE: Replace "___" with a proper dict
tool_registry = "___"
...
if tool_registry == "___":
    checks_2.append(("Registry is a dict", "TODO"))
    checks_2.append(("Has read_file", "TODO"))
    checks_2.append(("Has write_file", "TODO"))
    checks_2.append(("Has run_tests", "TODO"))
else:
    # Check it's a dict
...
print("  In the agent loop, after running tests and finding failures,")
print("  which phase does the agent go to next?\n")
print("  Choices: 'plan', 'code', 'test', 'reflect', 'iterate'\n")

# YOUR CODE HERE: Replace "___" with the correct phase name
on_test_failure = "___"

correct_answer = "reflect"

if on_test_failure == "___":
    status3 = "TODO"
    score3 = 0
elif on_test_failure.strip().lower() == correct_answer:
    status3 = "PASS"
    score3 = 1
else:
    status3 = "FAIL"
